...
shasum -a 256 dist/wispwire-0.1.5.tar.gz dist/wispwire-0.1.5-py3-none-any.whl
git tag v0.1.5
git push origin main v0.1.5
```

После появления GitHub Release нужно сверить SHA-256 `wispwire-0.1.5.tar.gz`
